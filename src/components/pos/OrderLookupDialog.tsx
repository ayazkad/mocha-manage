              ...
              <div className="space-y-4 pr-4">
                ...
                <div className="bg-muted p-4 rounded-lg space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-primary">{orderDetails.total.toFixed(2)} MAD</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="border-t pt-3 space-y-2">
                  <div className="flex justify-between text-sm">
                    ...
                    <span>{orderDetails.subtotal.toFixed(2)} MAD</span>
                  </div>
                  {orderDetails.discount_amount > 0 && (
                    <div className="flex justify-between text-sm">
                      <span className="text-muted-foreground">Réduction</span>
                      <span className="text-red-600">-{orderDetails.discount_amount.toFixed(2)} MAD</span>
                    </div>
                  )}
                  <div className="flex justify-between text-lg font-bold pt-2 border-t">
                    <span>Total</span>
                    <span>{orderDetails.total.toFixed(2)} MAD</span>
                  </div>
                </div>
